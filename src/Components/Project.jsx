...
export default function App() {
  ...
  return (
    <>
      <div className="mane h-screen w-full bg-[#1a1919]  relative" id='Project'>

        {/* Blur effect only for desktop */}
        <div className="blur-overlay absolute top-[10%] left-[16%] w-[400px] h-[400px] bg-gradient-to-r from-[#9f86c0] to-[#1b263b] opacity-40 rounded-full filter blur-3xl hidden md:block"></div>
        <div className="blur-overlay absolute top-[40%] left-[65%] w-[400px] h-[400px] bg-gradient-to-r from-[#9f86c0] to-[#1b263b] opacity-40 rounded-full filter blur-3xl hidden md:block"></div>
